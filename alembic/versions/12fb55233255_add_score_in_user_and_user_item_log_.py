...
def upgrade() -> None:
    ...
    op.add_column('user', sa.Column('score', sa.Integer(), nullable=False, server_default="0"))
    op.add_column('user_item_log', sa.Column('score', sa.Integer(), nullable=False, server_default="0"))
